import { PhoneIcon, MoonIcon, LanguageIcon } from '@heroicons/react/24/outline';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faExclamation } from '@fortawesome/free-solid-svg-icons';

export function PhoneIconCustom({ className }) {
    return <PhoneIcon className={className} />;
}

export function MoonIconCustom({ className }) {
    return (
        <svg
...
export function LanguageIconCustom({ className }) {
    return (
        <svg
            xmlns='http://www.w3.org/2000/svg'
            fill='none'
...
export function TickIconCustom({ className }) {
    return (
        <svg
            xmlns='http://www.w3.org/2000/svg'
            fill='none'
...
export function ArrowToTop({ className = 'size-3 inline-flex ml-2' }) {
    return (
        <svg
            xmlns='http://www.w3.org/2000/svg'
            viewBox='0 0 24 24'
...
export function WarningIcon({ className }) {
    return <FontAwesomeIcon icon={faExclamation} className={className} />;
}
...
export function UserNoBorderIcon({ className }) {
    return (
        <svg
            xmlns='http://www.w3.org/2000/svg'
            fill='none'
...
export function IdIcon({ className }) {
    return (
        <svg
            xmlns='http://www.w3.org/2000/svg'
            fill='none'
